...
YY_RULE_SETUP
#line 11 "rage.yy"
printf("%s:That's a number\n", yytext);
	YY_BREAK
case 4:
YY_RULE_SETUP
#line 12 "rage.yy"
printf("%s:That's a word\n", yytext);
	YY_BREAK
case 5:
YY_RULE_SETUP
#line 13 "rage.yy"
printf("%s:That's a punctuation\n", yytext);
	YY_BREAK
case 6:
YY_RULE_SETUP
#line 16 "rage.yy"
